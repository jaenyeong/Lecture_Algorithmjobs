...
public class Poacher {
    ...
    <밀렵꾼01.png>의 멧돼지들의 정보는 <밀렵꾼02.png>에서 각 멧돼지 아래에 멧돼지 구분자, 속력, 크기 순서대로 적혀있다.
    <밀렵꾼03.png>은 <밀렵꾼02.png>에서 1초가 지난 뒤 모습이다.
    멧돼지가 이동한 <밀렵꾼03.png> 모습 직후 밀렵꾼이 한 칸 이동하여 손전등을 비춰서 멧돼지를 확인한다.
