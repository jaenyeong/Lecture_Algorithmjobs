package com.jaenyeong.previousproblem.lv01.step04;

import java.util.Scanner;

public class UpDownLeftRightShift {
    /*
    상하좌우 SHIFT 알고리즘

    [문제]
    N x M 크기의 2차원 배열이 있다.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < distToMove; i++) {
            currentRow += ROW_DIR[direction];
            currentCol += COL_DIR[direction];
        }
